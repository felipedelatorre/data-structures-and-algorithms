...
describe('quickSort\'s Description ', () => {
  ...
  it('should sort by number (short array)', () => {
    shortArray = quickSort(shortArray, 0, shortArray.length - 1);
  ...
  it('should sort by number (long array)', () => {
    longArray = quickSort(longArray, 0, longArray.length - 1);
  ...
  it('should sort by number (odd array)', () => {
    oddArray = quickSort(oddArray, 0, oddArray.length - 1);
  ...
  it('should sort by number (even array)', () => {
    evenArray = quickSort(evenArray, 0, evenArray.length - 1);
  ...
  //   expect(() => {
  //     quickSort(shortArray, 0, shortArray.length - 1).toThrow();
  //   });
  // });
  ...
  //   let string = 'Hello!!!';
  //   expect(() => {
  //     quickSort(string, 0, string.length - 1).toThrow();
  //   });
  // });
